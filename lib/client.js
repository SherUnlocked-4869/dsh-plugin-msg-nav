window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      ".dsnv-panel-scroll{position:relative;padding:3px 0;transition:transform .12s ease-out}",
      ...
      return function NavRail(props) {
        ...
        return React.createElement('div', {
          ...
          railHot && shown ? React.createElement('div', {
            ...
            style: { right: (rightPx + 54.2) + 'px', top: (topPx - railH * 0.15 - 3) + 'px', height: (railH * 1.3 + 6) + 'px' },
            children: React.createElement('div', {
              key: 'scroll',
