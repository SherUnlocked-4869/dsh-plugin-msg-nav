window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      ".dsnv-panel-row{position:absolute;left:0;right:0;height:20px;box-sizing:border-box;display:flex;align-items:center;gap:12px;padding:0 10px 0 18px;border:0;border-radius:8px;background:transparent;cursor:pointer;font-size:13px;line-height:20px;color:var(--dsw-alias-label-secondary, rgba(255,255,255,.72));white-space:nowrap}",
