window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      ".dsnv-panel-row{position:absolute;left:0;right:0;height:20px;box-sizing:border-box;display:flex;align-items:center;justify-content:space-between;gap:10px;padding:0 16px;border:0;background:transparent;cursor:pointer;font-size:13px;line-height:20px;color:var(--dsw-alias-label-tertiary, rgba(255,255,255,.45));white-space:nowrap}",
      ...
      return function NavRail(props) {
        ...
        return React.createElement('div', {
          ...
          railHot && shown ? React.createElement('div', {
            ...
            style: { right: (rightPx + 44) + 'px', top: (topPx - 8) + 'px', height: (railH + 16) + 'px' },
